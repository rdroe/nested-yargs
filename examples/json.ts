import { cli, grn, termGreenMsg } from '../src/shared/utils/cli'
import * as readline from 'readline';
import { stdin as input, stdout as output } from 'node:process'

let targetDir: string

const defaultProjName = 'nya-json-app'
...
`
        ...
        msg('\n\n\ncompleted js-build; now running  "node ${targetDir}/public/js/myapp.js". export json and run browser version, where the data will be importable. ')
        await import(`${targetDir}/public/js/myapp.js`);
        return 'exit 0'
    })
